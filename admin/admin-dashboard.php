...
<div class="flex min-h-screen">
  ...
  <aside class="bg-gray-800 text-white w-64 space-y-6 py-7 px-2">
    <div class="text-center text-xl font-bold text-white">Admin Panel</div>
    <nav class="text-sm">
      <!-- Dashboard -->
      ...
      <div class="group">
        ...
        <div class="hidden pl-8 space-y-2 group-hover:block">
          ...
          <a href="#" class="flex items-center py-2 px-4 rounded hover:bg-gray-700" id="view-users-link">
...
<!-- Les rôles -->
      ...
      <div class="group">
        ...
        <div class="hidden pl-8 space-y-2 group-hover:block">
          <a href="#" class="flex items-center py-2 px-4 rounded hover:bg-gray-700" id="manage-shops-link">
            <i class="fas fa-tools mr-3"></i> Gérer les boutiques
          </a>
          <a href="#" class="flex items-center py-2 px-4 rounded hover:bg-gray-700" id="validate-shop-link">
            <i class="fas fa-check-circle mr-3"></i> Valider une boutique
          </a>
          <a href="#" class="flex items-center py-2 px-4 rounded hover:bg-gray-700 " id="add-product-link">
  ...
  <main class="flex-1 bg-gray-100 p-6">
    <div id="dynamic-content">
      <h1 class="text-2xl font-bold mb-6">Bienvenue sur le Dashboard Admin</h1>
