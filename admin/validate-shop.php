<div class="flex justify-center items-center min-h-screen bg-gray-100">
  <div class="bg-white shadow-lg rounded-lg p-6 w-full max-w-4xl">
    <h2 class="text-lg font-bold mb-4 text-center">Boutiques en attente de validation</h2>
    <table class="min-w-full text-sm border border-gray-300">
      <thead class="bg-gray-200 text-gray-600 uppercase text-xs">
        <tr>
          <th class="py-3 px-4 text-left border-b">Nom de la boutique</th>
          <th class="py-3 px-4 text-left border-b">Propriétaire</th>
      ...
      <tbody class="text-gray-700">
        ...
        <?php for ($i = 1; $i <= 5; $i++) : ?>
          <tr class="border-b hover:bg-gray-100">
            <td class="py-3 px-4">Boutique <?= $i ?></td>
            <td class="py-3 px-4">Propriétaire <?= $i ?></td>
            <td class="py-3 px-4">Adresse <?= $i ?></td>
            <td class="py-3 px-4">08h-18h</td>
            <td class="py-3 px-4 text-center">
              <button class="bg-green-500 text-white py-1 px-2 rounded text-xs">Valider</button>
              <button class="bg-red-500 text-white py-1 px-2 rounded text-xs">Rejeter</button>
            </td>
          </tr>
        <?php endfor; ?>
      </tbody>
